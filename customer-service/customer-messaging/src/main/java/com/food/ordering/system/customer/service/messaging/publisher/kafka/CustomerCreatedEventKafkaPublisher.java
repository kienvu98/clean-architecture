...
public class CustomerCreatedEventKafkaPublisher implements CustomerMessagePublisher {
    ...
    public void publish(CustomerCreatedEvent customerCreatedEvent) {
        ...
        try {
            String customerId = customerCreatedEvent.getCustomer().getId().toString();
    ...
    private ListenableFutureCallback<SendResult<String, CustomerAvroModel>> getCallback(String topicName, CustomerAvroModel customerAvroModel) {
