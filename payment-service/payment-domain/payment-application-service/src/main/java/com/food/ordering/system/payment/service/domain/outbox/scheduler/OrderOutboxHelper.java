...
public class OrderOutboxHelper {
    ...
    public Optional<OrderOutboxMessage> getCompletedOrderOutboxMessageBySagaIdAndPaymentStatus(UUID sagaId, PaymentStatus paymentStatus) {
        return orderOutboxRepository.findByTypeAndSagaIdAndPaymentStatusAndOutboxStatus(ORDER_SAGA_NAME, sagaId, paymentStatus,
    ...
    public void saveOrderoutboxMessage(OrderEventPayload orderEventPayload, PaymentStatus paymentStatus,
        ...
        save(OrderOutboxMessage.builder()
                ...
                .payload(createdPayload(orderEventPayload))
    ...
    private String createdPayload(OrderEventPayload orderEventPayload) {
        try {
            return objectMapper.writeValueAsString(orderEventPayload);
        } catch (JsonProcessingException e) {
            log.error("Could not create OrderEventPayload json!", e.getMessage());
            throw new PaymentDomainException("Could not create OrderEventPayload json!" + e.getMessage());
        }
    }
