...
@Slf4j
@Component
public class PaymentCompletedKafkaMessagePublisher implements DomainEventPublisher<PaymentCompleteEvent> {
    ...
    @Override
    public void publisher(PaymentCompleteEvent domainEvent) {
        ...
        try {
            PaymentResponseAvroModel paymentResponseAvroModel = paymentMessagingDataMapper
                    .paymentCompleteEventtoPaymentResponseAvroModel(domainEvent);
