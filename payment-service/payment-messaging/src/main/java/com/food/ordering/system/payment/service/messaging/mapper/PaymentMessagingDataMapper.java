...
public class PaymentMessagingDataMapper {
    ...
    public PaymentResponseAvroModel paymentCompleteEventtoPaymentResponseAvroModel(PaymentCompleteEvent paymentCompleteEvent) {
        return PaymentResponseAvroModel.newBuilder()
                ...
                .setSagaId("")
                .setPaymentId(paymentCompleteEvent.getPayment().getId().toString())
                .setCustomerId(paymentCompleteEvent.getPayment().getCustomerId().toString())
                .setOrderId(paymentCompleteEvent.getPayment().getOrderId().toString())
    ...
    public PaymentResponseAvroModel paymentFailedEventtoPaymentResponseAvroModel(PaymentFalledEvent paymentFalledEvent) {
        return PaymentResponseAvroModel.newBuilder()
                .setId(UUID.randomUUID().toString())
                .setSagaId("")
                .setPaymentId(paymentFalledEvent.getPayment().getId().toString())
                .setCustomerId(paymentFalledEvent.getPayment().getCustomerId().toString())
                .setOrderId(paymentFalledEvent.getPayment().getOrderId().toString())
