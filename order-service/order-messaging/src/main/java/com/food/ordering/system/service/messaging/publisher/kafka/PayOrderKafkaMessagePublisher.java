...
import com.food.ordering.system.order.service.domain.ports.output.message.pulisher.restaurantapproval.OrderPaidRestaurantRequestMessagePublisher;
...
public class PayOrderKafkaMessagePublisher implements OrderPaidRestaurantRequestMessagePublisher {
    ...
    @Override
    public void publisher(OrderPaidEvent domainEvent) {
        String orderId = domainEvent.getOrder().getId().toString();
        try {
            RestaurantApprovalRequestAvroModel restaurantApprovalRequestAvroModel =
                    orderMessagingDataMapper.orderPaiEventToRestaurantApprovalRequestAvroModel(domainEvent);
