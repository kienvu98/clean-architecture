    ...
    public void recevie(@Payload List<PaymentResponseAvroModel> message,
        ...
        message.forEach(paymentResponseAvroModel -> {
            if (PaymentStatus.COMPLETED == paymentResponseAvroModel.getPaymentStatus()) {
                log.info("Processing successfuly payment for order id: {}", paymentResponseAvroModel.getOrderId());
                ...
                log.info("Processing unsuccessfuly payment for order id: {}", paymentResponseAvroModel.getOrderId());
