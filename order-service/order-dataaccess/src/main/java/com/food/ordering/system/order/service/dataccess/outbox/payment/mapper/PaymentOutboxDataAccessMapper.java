package com.food.ordering.system.order.service.dataccess.outbox.payment.mapper;
...
public class PaymentOutboxDataAccessMapper {
    ...
    public PaymentOutboxEntity paymentOutboxMessageToPaymentOutboxEntity(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
