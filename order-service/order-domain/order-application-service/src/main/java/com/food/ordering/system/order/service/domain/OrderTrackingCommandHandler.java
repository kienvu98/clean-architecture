...
public class OrderTrackingCommandHandler {
    ...
    public OrderTrackingCommandHandler(OrderDataMapper orderDataMapper,
    ...
    public TrackingOrderResponse trackingOrder(TrackOrderQuery trackOrderQuery) {
        ...
        return orderDataMapper.orderToTrackingOrderResponse(orderResult.get());
    }
