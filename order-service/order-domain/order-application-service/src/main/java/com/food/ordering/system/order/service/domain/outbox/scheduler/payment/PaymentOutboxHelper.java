...
public class PaymentOutboxHelper {
    ...
    @Transactional(readOnly = true)
    public Optional<OrderPaymentOutboxMessage> getPaymentOutboxMessagaIdAndSagaStatus(UUID sagaId, SagaStatus... sagaStatus) {
    ...
    public void save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        ...
        log.info("OrderPyamentOutboxMessage saved with outbox id: {}", orderPaymentOutboxMessage.getId());
    }

    @Transactional
    public void deletePaymentOutboxMessageOutboxStatusAndSagaStatus(OutboxStatus outboxStatus, SagaStatus... sagaStatus) {
    ...
    public void savePaymentOutboxMessage(OrderPaymentEventPayload orderPaymentEventPayload,
        ...
        save(OrderPaymentOutboxMessage.builder()
                ...
                .payload(createdPayload(orderPaymentEventPayload))
                .orderStatus(orderStatus)
                .sagaStatus(sagaStatus)
    ...
    private String createdPayload(OrderPaymentEventPayload paymentEventPayload) {
        try {
