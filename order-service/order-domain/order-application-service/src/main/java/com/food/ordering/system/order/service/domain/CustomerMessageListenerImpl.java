...
public class CustomerMessageListenerImpl implements CustomerMessageListener {
    ...
    public void customerCreated(CustomerModel customerModel) {
        ...
        if (customer == null){
            log.error("Customer could not be create in order database with id: {}", customerModel.getId());
            throw new OrderDomainException("Customer could not be create in order database with id: " +  customerModel.getId());
        }
