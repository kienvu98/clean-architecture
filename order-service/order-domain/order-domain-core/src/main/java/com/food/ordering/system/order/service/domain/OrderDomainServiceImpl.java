...
public class OrderDomainServiceImpl implements OrderDomainService{
    ...
    public OrderCreatedEvent validateAndInitiateOrder(Order order, Restaurant restaurant,
        ...
        validateRestaunrant(restaurant);
        setOrderProductInfomation(order, restaurant); // chuyển thông tin của đơn hàng và nhà hàng
        order.validateOrder();
        order.inintializerOrder();
        log.info("Order with id: {} is initiaed", order.getId().getValue());
    ...
    private void validateRestaunrant(Restaurant restaurant) {
        if(!restaurant.isActive()){ // kiểm tra nhà hàng có hoạt động không
